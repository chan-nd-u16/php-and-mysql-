...
<body>
<h2 style="text-align: center;"> ADMIN SIGNUP PAGE</h2>
  <div class="main">
...
$targetDir = "images/";
  ...
  if(!empty($_FILES["productimg"]["name"])){
    ...
    $insert = mysqli_query($auth,"INSERT INTO `admin`(name,username,profile,phone,email,password) VALUES('$name','$u_name','$fileName','$phone','$email','$password')");
